...
impl Vertex {
    ...
    pub fn shader(&self, texture: &DynamicImage) -> u32 {
        ...
        //let value =  (((100000000.0 / (magnitude).powi(2))).clamp(0.0,255.0) * dot) as usize;
        let r = (sample[0] as f64 * dot ) as u32;
        let g = (sample[1] as f64 * dot ) as u32;
        let b = (sample[2] as f64 * dot ) as u32;
